...
class CompanyResetPassword extends Component {
    constructor(props) {
        super(props)
        this.handleSubmit = this.handleSubmit.bind(this)
    }
    handleSubmit(values) {
        this.props.companyNewPassword(values.password, this.props.token);
    }
    render() {
        return (
...
export default withRouter(CompanyResetPassword)