                ...
                {Object.keys(this.props.user.user).length !== 0 ?
                    <div className='row justify-content-center profile-back'>
                        ...
                        <div className='col-md-5 col-12 user-profile-block' align='center'>
                            ...
                            <div className='row'>
                                ...
                                <div className='col-md-6 col-6'><button className='reset-password' onClick={() => { this.props.history.push('/users/forgetpassword') }}>Reset Password</button></div>
                            </div>
                        </div>
                    </div>
                    :
                    <div className='row mt-5 mb-5' align='center'>
                        <div className='col-lg-4 col-12 m-auto bg-info pt-5 pb-5 text-white'>
                            ...
                            <p>Looks like you are not logged in, Log In to view this page.</p>
                            <button className='btn btn-success' onClick={() => { this.props.history.push('/signin') }}>Login here <span className='fa fa-space-shuttle'></span></button>
                        </div>
                    </div>
                }
            </div>
